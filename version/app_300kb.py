                ...
                try:
                    ...
                    for page_index, page in enumerate(doc):
                        ...
                        for img in images:
                            ...
                            # Converte imagem para PIL e redimensiona
                            imagem_pil = Image.frombytes("RGB", [pix.width, pix.height], pix.samples)
                            imagem_redimensionada = imagem_pil.resize((1670, 2373), Image.LANCZOS)

                            # Salva imagem com qualidade alta
                            ...
                            st.success(f"✅ Salvo: `{nome_arquivo}` ({round(tamanho_kb)} KB)")
